...
public class CollectServiceImpl extends CacheService implements CollectService {
     ...
     * @param specUserId  规范用户id
     * @return {@link List}<{@link CollectSummary}>
     * @author neo
     * @date 2016年8月24日
     */
    @Override
    ...
    public void saveCollect(Collect collect) {
        ...
        collect.setLastModifyTime(new Timestamp(System.currentTimeMillis()));
    ...
    private void noticeFriends(Collect collect) {
        if (StringUtils.isNotBlank(collect.getRemark()) && collect.getRemark().contains("@")) {
    ...
    public void like(Long userId, long id) {
        ...
        if (praise == null) {
            ...
            newPraise.setCreateTime(new Timestamp(System.currentTimeMillis()));
